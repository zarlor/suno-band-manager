...
>
> **Last validated:** April 6, 2026 (Suno v5.5 Pro, v5 Pro, v4.5-all, v4.5 Pro, v4.5+ Pro, v4 Pro). Suno updates models and prompt behavior frequently — use web search to verify strategies against current documentation when uncertain.
