...
- **Inline BPM and meter tags don't move the tempo** (LOCAL-OBSERVED: `[Verse 1: 65 BPM, 6/8]` … `[Verse 3: 150 BPM, 4/4]` came back on one flat grid). Put the *feel* in the section cue — half-time or double-time, sparse or dense — and leave any BPM figure to the style field as soft reinforcement paired with feel words.
