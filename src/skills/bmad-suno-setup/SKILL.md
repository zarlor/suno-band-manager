---
name: bmad-suno-setup
description: Sets up BMad Suno Band Manager module in a project. Use when the user requests to 'install suno module', 'configure BMad Suno Band Manager', or 'setup BMad Suno Band Manager'.
---
